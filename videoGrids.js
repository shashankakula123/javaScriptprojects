...
function generateVideoCard(videoData) {
  ...
  deleteIcon.onclick=function(){
    alert('deleteIconclicked for=>'+videoData.id);
    var selectedElement=document.getElementById(videoData.id);
...
// 	  var deleteIcon = <i class="fas fa-trash-alt"></i>document.createElement('i');
// 	  deleteIcon.className = "fas fa-trash delete-icon";

	
	// deleteIcon.onclick= function(){
	// 	alert('delete Icon clicked for =>'+videoData.title);
//     var myobj=document.getElementById(videoData.id);
//     myobj.remove();
